...
#include "tensorflow/lite/micro/examples/hello_world_01/models/hello_world_float_model_data.h"
#include "tensorflow/lite/micro/examples/hello_world_01/models/hello_world_int8_model_data.h"
